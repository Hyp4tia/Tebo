...
// MARK: - WhitelistStore
// Persists the user's protected paths to ~/.config/superclean/whitelist
...
public enum WhitelistStore {
    ...
    /// Live config dir: ~/.config/superclean (created on first save).
    public static func configDirectory() -> URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent(".config/superclean", isDirectory: true)
    }
    ...
    public static func save(_ entries: Set<String>, to url: URL? = nil) {
        ...
        var text = "# SuperClean whitelist — one protected substring per line.\n"
