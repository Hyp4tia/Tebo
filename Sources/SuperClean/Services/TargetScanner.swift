    ...
    public func scan(
        ...
        for target in targets {
            ...
            if target.needsAdmin {
                // Mole runs these through sudo; SuperClean deliberately does not ask for root in 1.0.
                advisories.append(AdvisoryRow(
                    id: "admin:\(target.label)",
                    title: target.label,
                    detail: "Needs an administrator password, which SuperClean never asks for. Not touched.",
