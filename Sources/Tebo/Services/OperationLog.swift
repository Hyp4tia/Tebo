...
// Path: ~/Library/Logs/tebo/operations.log
...
public actor OperationLog {
    ...
    private let logger = Logger(subsystem: "com.tebo.app", category: "operations")
    ...
    private static func logDirectory() -> URL {
        FileManager.default.urls(for: .libraryDirectory, in: .userDomainMask)
            .first?
            .appendingPathComponent("Logs/tebo", isDirectory: true)
