...
// MARK: - SelfTest
// Headless entry point: `Tebo --selftest` prints what the app can actually see on this machine
...
enum SelfTest {
    ...
    private static func makeFixtureTree(directoryCount: Int, filesPerDirectory: Int) throws -> URL {
        let root = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("tebo-bench-\(UUID().uuidString)")
