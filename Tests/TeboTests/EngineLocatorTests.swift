...
struct EngineLocatorTests {
    ...
    private func makeBinary(contents: Data, executable: Bool = true) throws -> (URL, String) {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("tebo-engine-\(UUID().uuidString)")
    ...
    func knownVector() throws {
        ...
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("tebo-hash-\(UUID().uuidString)")
        try FileManager.default.createDirectory(at: dir, withIntermediateDirectories: true)
    ...
    func missingEngine() {
        let nowhere = FileManager.default.temporaryDirectory
            .appendingPathComponent("tebo-absent-\(UUID().uuidString)/czkawka_cli")
