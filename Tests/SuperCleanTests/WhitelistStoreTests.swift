...
private func scratchWhitelistURL() -> URL {
    FileManager.default.temporaryDirectory
        .appendingPathComponent("superclean-test-\(UUID().uuidString)/whitelist")
}
...
struct CleanerServiceSizingTests {
    ...
    private func makeTree() -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superclean-size-\(UUID().uuidString)")
    ...
    func missingPath() {
        let missing = FileManager.default.temporaryDirectory
            .appendingPathComponent("superclean-nope-\(UUID().uuidString)").path
...
struct CleanerServiceLocationTests {
    ...
    private func makeLocation() -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("superclean-loc-\(UUID().uuidString)")
...
struct CleanerServicePurgeTests {
    ...
    private func makeProject() -> URL {
        let proj = FileManager.default.temporaryDirectory
            .appendingPathComponent("superclean-proj-\(UUID().uuidString)")
